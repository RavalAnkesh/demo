...
document.write("<br><br>Example Of ASYNC, AWAIT,PROMISE")

async function demo() {
    document.write("<br>Inside async function<br>")

    await Promise.resolve() 

    document.write("After await executed<br>")
}
demo()


let a1 = new Array(100)
let pro=new Promise((resolve,rejected)=>{
    if(a1.length >= 100){
        resolve("<br>Promise Executed Successful")
    }else{
        rejected("<br>Promise Rejected ")
    }
})
pro.then((msg)=>document.write(msg))
